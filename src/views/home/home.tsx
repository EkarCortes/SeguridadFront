    ...
    <div className="w-full min-h-[600px] p-2 md:p-4">
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col md:flex-row gap-4 w-full">
          <div
            className="flex-1 rounded-lg shadow-lg p-4 min-h-[370px] flex items-center justify-center bg-white"
            style={{ color: "#1f364a" }}
          >
          ...
          <div
            className="w-full md:w-[350px] rounded-lg shadow-lg p-4 min-h-[370px] flex flex-col items-center justify-center bg-white box-border"
            style={{ color: "#1f364a" }}
          >
            {monthlyLoading ? (
              <DonutChart 
        ...
        <div className="w-full">
          <div
            className="rounded-lg shadow-lg p-4 min-h-[370px] flex items-center justify-center bg-white"
            style={{ color: "#1f364a" }}
          >
            <AccessTable />
          </div>
